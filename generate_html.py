...
#legend{position:absolute;top:14px;right:14px;background:rgba(255,255,255,.9);border:1px solid var(--border);
...
.leg-grad{height:10px;border-radius:4px;background:linear-gradient(to right,rgba(59,130,246,0.45),rgba(189,50,46,0.8),rgba(220,20,20,0.9));margin-bottom:3px;}
